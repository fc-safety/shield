  ...
  const FORM_DEFAULTS = useMemo(
    () =>
      ({
        ...
        productCategory: connectOrEmpty(productCategory?.id ?? parentProduct?.productCategoryId),
        manufacturer: connectOrEmpty(manufacturer?.id ?? parentProduct?.manufacturerId),
        name: "",
        description: "",
        sku: "",
        productUrl: "",
