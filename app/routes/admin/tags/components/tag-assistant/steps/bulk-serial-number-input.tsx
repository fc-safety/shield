          ...
          <TabsTrigger value="sequential" className="flex items-center gap-1">
            ...
            <HelpPopover>
              <div className="space-y-2">
                <p>
                  Generate a large set of serial numbers by providing a starting
                  and ending serial number. Serial numbers will be automatically
                  generated to fill the range.
                </p>
                <p>
        ...
        <TabsContent value="sequential" className="my-4 flex flex-col gap-4">
          ...
          <div className="w-full">
            ...
            <p className="text-xs text-muted-foreground italic mt-1">
              Optionally, select a quick increment to populate the ending serial
              number.
            </p>
          </div>
        </TabsContent>
